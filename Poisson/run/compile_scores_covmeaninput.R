...
main_path <- "/rds/general/user/sv20/home/simulation_block_approach/New/Poisson/results/scores/old_mrf_meancovinput"
...
all_proper_scores <- map_dfr(1:12, function(sim_i) {
...
save(all_proper_scores,
     file = "/rds/general/user/sv20/home/simulation_block_approach/New/Poisson/results/compile_scores/properscores_covmeaninput.Rdata")
...
fixedparam_scores <- map_dfr(1:12, function(sim_i) {
...
save(fixedparam_scores,
     file = "/rds/general/user/sv20/home/simulation_block_approach/New/Poisson/results/compile_scores/paramscores_fixedeffects_covmeaninput.Rdata")
...
hyperparam_scores <- map_dfr(1:12, function(sim_i) {
...
save(hyperparam_scores,
     file = "/rds/general/user/sv20/home/simulation_block_approach/New/Poisson/results/compile_scores/paramscores_hyperparams_covmeaninput.Rdata")
...
all_other_scores <- map_dfr(1:12, function(sim_i) {
...
save(all_other_scores,
     file = "/rds/general/user/sv20/home/simulation_block_approach/New/Poisson/results/compile_scores/otherscores_covmeaninput.Rdata")
...
main_path <- "/rds/general/user/sv20/home/simulation_block_approach/New/Poisson/results/scores/old_mrf_meancovinput/coverage"
...
all_coverage_scores_mu <- map_dfr(1:12, function(sim_i) {
...
save(all_coverage_scores_mu,
     file = "/rds/general/user/sv20/home/simulation_block_approach/New/Poisson/results/compile_scores/all_coverage_scores_mu_covmeaninput.Rdata")
...
all_coverage_scores_y <- map_dfr(1:12, function(sim_i) {
...
save(all_coverage_scores_y,
     file = "/rds/general/user/sv20/home/simulation_block_approach/New/Poisson/results/compile_scores/all_coverage_scores_y_covmeaninput.Rdata")
