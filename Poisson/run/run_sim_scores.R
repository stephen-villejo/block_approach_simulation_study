...
dataloc <- "/rds/general/user/sv20/home/simulation_block_approach/New/Poisson/data/"
model_loc <- "/rds/general/user/sv20/home/simulation_block_approach/New/Poisson/results/inlamodels/"
saveloc <- "/rds/general/user/sv20/home/simulation_block_approach/New/Poisson/results/scores/"
...
for(j in param_id){
  ...
  for(i in 1:n_sim){
    ...
    sim_data$data_Y$covariate <- sim_data$data_Y$covariate_sum
    sim_data$mu_B$covariate <- sim_data$mu_B$covariate_sum
